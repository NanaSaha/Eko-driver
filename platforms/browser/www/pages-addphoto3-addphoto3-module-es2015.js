...
let Addphoto3PageModule = class Addphoto3PageModule {
};
...
let Addphoto3Page = class Addphoto3Page {
    ...
    send(subject, message, email) {
        const url = "https://api.mailgun.net/v3/" + this.settings.mailGUrl + "/messages";
        const body = {
            from: email,
    ...
    processProfilePicture(captureData) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const storageRef = firebase_app__WEBPACK_IMPORTED_MODULE_5__["storage"]().ref();
...
//# sourceMappingURL=pages-addphoto3-addphoto3-module-es2015.js.map