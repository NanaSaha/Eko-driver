...
var RefcodePageModule = /** @class */ (function () {
    function RefcodePageModule() {
    }
...
var RefcodePage = /** @class */ (function () {
    function RefcodePage(ph, share, lp, pop, eProvider, platform, nav, loadingCtrl, location, alertCtrl, settings, formBuilder) {
        var _this = this;
        this.ph = ph;
        this.share = share;
        this.lp = lp;
        ...
        this.ph.getUserProfile().on("value", function (userProfileSnapshot) {
            if (userProfileSnapshot.val()) {
                ...
                console.log("VALUE FROM USER PROFILE" + _this.ph.id);
                console.log("unique_number is " + userProfileSnapshot.val().unique_number);
                _this.earnings = userProfileSnapshot.val().refEarning;
                console.log("EARNINGSS" + _this.earnings);
                // this.randomCode = userProfileSnapshot.val().id;
                _this.randomCode = userProfileSnapshot.val().unique_number;
            }
            else {
                _this.earnings = 0;
                console.log("EARNINGSS 0" + _this.earnings);
            }
        });
        // this.pop.hideLoader();
    ...
    RefcodePage.prototype.ionViewDidEnter = function () {
        this.message =
            "Share " +
                this.randomCode +
    ...
    RefcodePage.prototype.goBack = function () {
        // this.location.back();
        this.nav.navigateBack("home");
    };
    RefcodePage.prototype.gotoEarning = function () {
        this.nav.navigateRoot("earnings");
    };
    RefcodePage.prototype.FaceShare = function () {
        this.share
            .share(this.message, this.subject, this.file, this.link)
            .then(function () { })
            .catch(function () { });
    };
    RefcodePage.prototype.whatsappShare = function () {
        this.share
    ...
    RefcodePage.prototype.Request = function () {
        // this.send(
    ...
    //   };
    // }
    RefcodePage.prototype.ngOnInit = function () {
        this.file = "https://ekodot.devdexsoftware.com";
        this.link = "https://ekodot.devdexsoftware.com";
    };
    RefcodePage.ctorParameters = function () { return [
...
//# sourceMappingURL=refcode-refcode-module-es5.js.map