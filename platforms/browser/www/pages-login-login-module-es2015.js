...
let LoginPage = class LoginPage {
    constructor(pop, navCtrl, lp, settings, platform, menu, loadingCtrl, zone, alertCtrl, authProvider, ph, formBuilder, router) {
        this.pop = pop;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (!this.loginForm.valid) {
                ...
                this.authProvider
                    ...
                    .then((authData) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield loading.present().then(() => {
                if (this.PhoneNo && this.CountryCode) {
                    this.authProvider
                        .signInWithPhoneNumber(this.recaptchaVerifier, this.CountryCode + this.PhoneNo)
                        .then((success) => {
