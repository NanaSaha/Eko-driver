...
var SchedulePage = /** @class */ (function () {
    function SchedulePage(navCtrl, One, lp, events, platform, activatedRoute, gCode, locat, settings, oneSignal, pop, load, profile, alert, eventProvider) {
        ...
        this.eventProvider.getCurrentDriver().remove().then(function (id) {
            ...
            _this.eventProvider.getActivityProfile(e.id).set({
                ...
                _this.platform.ready().then(function () {
                    _this.platform.backButton.subscribe(function () { return _this.pop.presentToast(_this.lp.translate()[0].k8); });
                });
