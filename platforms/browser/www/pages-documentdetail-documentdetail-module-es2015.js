...
let DocumentdetailPage = class DocumentdetailPage {
    constructor(activatedRoute, navCtrl, actionSheetCtrl, file, camera, lp, settings, pop, load, profile, alert, eventService) {
    ...
    processProfilePicture(captureData, id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            imageRef.putString(captureData, firebase_app__WEBPACK_IMPORTED_MODULE_3__["storage"].StringFormat.DATA_URL).then((snapshot) => {
...
//# sourceMappingURL=pages-documentdetail-documentdetail-module-es2015.js.map