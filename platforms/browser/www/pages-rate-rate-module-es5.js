...
var RatePage = /** @class */ (function () {
    function RatePage(navCtrl, Onesignal, activatedRoute, lp, storage, modal, pop, prof) {
    ...
    RatePage.prototype.onRateChange = function ($event) {
        var _this = this;
        this.rateNumber = $event;
    ...
    RatePage.ctorParameters = function () { return [
