...
var PhonePage = /** @class */ (function () {
    function PhonePage(navCtrl, settings, http, platform, pop, ph, loadingCtrl) {
    ...
    PhonePage.prototype.AuthPhone = function (phone) {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.http
                            ...
                            _this.requestCode = res.request_id;
                            console.log("RESPSONSE::: ", res);
                            console.log("REQUEST::: ", _this.requestCode);
                            loading_1.dismiss();
                        }, function (error) {
    ...
    PhonePage.prototype.AuthCode = function (code) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var loading_2;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.http
                            ...
                            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (response) { return response.json(); }))
                            .subscribe(function (res) {
                            if (res.status == 0) {
                                _this.ph.UpdateNumber(_this.PhoneNumber).then(function () {
                                    _this.navCtrl.navigateRoot("more-info");
                                    loading_2.dismiss();
                                });
                            }
                        }, function (error) {
                            _this.pop.showPimp("Couldnt get code");
                            _this.requestCode = false;
                            _this.userName = "";
                        });
                        _a.label = 3;
                    case 3: return [2 /*return*/];
    ...
    PhonePage.prototype.startTimer = function () {
        var _this = this;
        this.timeleft = 50;
...
//# sourceMappingURL=pages-phone-phone-module-es5.js.map