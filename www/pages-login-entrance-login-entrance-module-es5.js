...
var LoginEntrancePageModule = /** @class */ (function () {
...
var LoginEntrancePage = /** @class */ (function () {
    function LoginEntrancePage(navCtrl, lp, settings, zone, load) {
    ...
    LoginEntrancePage.prototype.ngOnInit = function () {
        console.log('ionViewDidLoad startup');
    };
    LoginEntrancePage.prototype.GotoLogin = function () {
        var _this = this;
        this.zone.run(function () {
            _this.navCtrl.navigateRoot('login');
        });
    };
    LoginEntrancePage.prototype.GotoSignup = function () {
        this.navCtrl.navigateRoot('signup');
    };
    LoginEntrancePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-login-entrance-login-entrance-module-es5.js.map