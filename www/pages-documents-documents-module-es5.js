...
var DocumentsPage = /** @class */ (function () {
    function DocumentsPage(navCtrl, camera, lp, settings, pop, load, profile, alert, eventProvider, route) {
    ...
    DocumentsPage.prototype.goBack = function () {
        this.navCtrl.navigateBack("home");
    };
    DocumentsPage.prototype.calcDate = function (date1, date2) {
    ...
    DocumentsPage.prototype.presentRouteLoader = function (message) {
    ...
    DocumentsPage.prototype.GotoItem = function (h) {
        console.log(h);
