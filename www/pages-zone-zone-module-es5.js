...
var ZonePage = /** @class */ (function () {
    function ZonePage(navCtrl, authProvider, eventProvider, locationTracker, dProvider, One, platform, pop, ph, lp, load) {
    ...
    ZonePage.prototype.ngOnInit = function () {
        var _this = this;
        this.ph.getDatabaseProfile().child('admin_zones').on('value', function (passengerSnapshot) {
            _this.eventList = [];
            console.log(passengerSnapshot.val());
            passengerSnapshot.forEach(function (element) {
    ...
    ZonePage.prototype.UseZone = function (lat, lng) {
        var _this = this;
        this.ph.isZone(lat, lng).then(function () {
            _this.pop.showPimp('Restart The App To Use The Selected Zone.');
        });
    };
    ZonePage.prototype.goBack = function () {
        this.navCtrl.navigateBack('home');
    };
    ZonePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-zone-zone-module-es5.js.map