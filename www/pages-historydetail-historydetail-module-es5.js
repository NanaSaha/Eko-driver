...
var HistorydetailPage = /** @class */ (function () {
    function HistorydetailPage(navCtrl, prof, settings, eventProvider, route) {
    ...
    HistorydetailPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        var g = [];
        var f = [];
        var b = [];
        ...
        this.eventProvider
            ...
            _this.tolls = _this.currentEvent.toll;
            _this.currentPrie = _this.currentEvent.realPrice;
            _this.surcharges = _this.currentEvent.surcharge;
            _this.osc = _this.currentEvent.osc;
            _this.riderpaid = _this.currentEvent.realPrice;
            _this.driverMade = _this.currentEvent.realPrice;
            if (_this.currentEvent.surcharge)
                for (var index = 0; index < _this.currentEvent.surcharge.length; index++) {
                    k.push(parseFloat(_this.currentEvent.surcharge[index].price));
                    var add = function (a, b) { return a + b; };
                    var result = k.reduce(add);
                    _this.totalSurge = result;
                    _this.actual = _this.currentEvent.price - _this.totalSurge;
                    console.log(_this.totalSurge);
                    _this.currentEvent.surcharge[index].price;
                }
            if (_this.surcharges)
                _this.surcharges.forEach(function (element) {
                    //if rider
                    if (element.owner == 1) {
                        //if percent
                        if (element.bone == 1) {
                            var fo = (element.price / 100) * _this.currentEvent.realPrice;
                    ...
                    if (element.owner == 0) {
                        ...
                        if (element.bone == 1) {
                            ...
                            console.log(nb * _this.currentEvent.tip);
                            var fo = nb * _this.currentEvent.tip;
                            j.push(fo);
                            var add2 = function (a, b) { return a + b; };
                            var result2 = j.reduce(add2);
                            _this.percentDrive = result2;
                            console.log((Math.floor(element.price) / 100) * _this.currentEvent.tip);
                        }
                        //if flat fee
                        if (element.bone == 0) {
                            m.push(parseFloat(element.price));
                            var add4 = function (a, b) { return a + b; };
                            var result4 = m.reduce(add4);
                            _this.flatDrive = result4;
                            console.log(result4);
                        }
                        _this.totalDriverSurg = _this.flatDrive + _this.percentDrive;
            ...
            console.log(_this.totalDriverSurg);
            _this.totemTIPS =
            ...
            if (_this.currentEvent.toll) {
                for (var index = 0; index < _this.currentEvent.toll.length; index++) {
                    b.push(_this.currentEvent.toll[index].tagCost);
                    var add = function (a, b) { return a + b; };
    ...
    HistorydetailPage.prototype.goBack = function () {
    ...
    HistorydetailPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-historydetail-historydetail-module-es5.js.map