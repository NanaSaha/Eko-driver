...
var PromoPage = /** @class */ (function () {
    function PromoPage(navCtrl, lp, ph, pop, location) {
    ...
    PromoPage.prototype.apply_code = function (code) {
    ...
    PromoPage.prototype.AddCode = function (code) {
        this.SearchForSharingIDs(code);
    };
    PromoPage.prototype.SearchForSharingIDs = function (promoID) {
        var _this = this;
        ...
        this.ph.getAllSharingPromoID(promoID).on("value", function (SharingIDShot) {
            if (SharingIDShot.val()) {
                ...
                _this.pop.presentToast("A DISCOUNT APPLIED TO YOUR NEXT RIDE");
            }
            else {
                _this.pop.presentToast("PROMO CODE NOT VALID");
                console.log("NOT VALID");
                _this.pop.hideLoader();
            }
        });
    };
    PromoPage.prototype.goBack = function () {
        this.location.back();
    };
    PromoPage.prototype.ngOnInit = function () { };
    PromoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-promo-promo-module-es5.js.map