...
var WalletPage = /** @class */ (function () {
    function WalletPage(navCtrl, alertCtrl, ph) {
        var _this = this;
    ...
    WalletPage.prototype.subscribe = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0: return [4 /*yield*/, this.alertCtrl.create({
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        _this.funds = data[0];
                                        console.log("FUNDS-->>" + _this.funds * 100);
                                    },
                                },
                            ],
                        })];
    ...
    WalletPage.prototype.updateFundsO = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.funds = parseInt(data[0]) + parseInt(_this.ph.funds);
                                        console.log("FUNDS-->>" + _this.funds * 100);
    ...
    WalletPage.prototype.paymentInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WalletPage.prototype.paymentDone = function (ref) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var reference, trans, status, user_id;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WalletPage.ctorParameters = function () { return [
